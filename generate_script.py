...
_TONE_FRAGMENTS = {
    ...
    "funny": (
        ...
        "referenced again three turns later for the second laugh). "
        "INVENT a fresh absurd analogy from THIS story's specific details — "
        "never reach for a stock comparison or a phrase you'd use on any other "
        "day. Do NOT use the 'X is the [famous thing] of [category]' template "
        "(e.g. 'the Crocs IPO of …') — it is banned; it has been overused. "
        "Vary your sentence shapes; no signature catchphrase should recur "
        "across episodes. Use deadpan reactions where the surprise is the lack "
        "of surprise. Hosts CAN punch up at institutions, hype cycles, CEO ego, "
        "regulator theater — never punch down at protected characteristics. "
        "NO dad jokes, NO 'why did the investor cross the road' setups, NO "
        "forced wordplay. Earn the laugh off the actual story or skip the joke."
    ),
}
...
8. NUMBERS + NAMES: write numbers as words for smooth TTS — "Up one point two percent", indices spelled digit-pairs ("seventy-one twenty-six" for 7126), dollar amounts spelled ("one hundred billion dollars" not "$100B"). For COMPANIES, prefer the company NAME, not the ticker — say "Nvidia" not "NVDA", "Broadcom" not "AVGO", "Salesforce" not "CRM", "Eli Lilly" not "LLY", "JPMorgan" not "JPM", "CrowdStrike" not "CRWD", "Cisco" not "CSCO", "AbbVie" not "ABBV", etc. Only use letter-spaced ticker form ("S and P", "Nasdaq", "V I X", "S P Y") for INDICES and ETFs that don't have a colloquial name. AMD, IBM, and other already-pronounced-as-letters tickers stay as the brand uses them ("A M D", "I B M").
